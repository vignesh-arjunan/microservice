...
public class AccountsRecord extends UpdatableRecordImpl<AccountsRecord> implements Record3<Integer, String, BigDecimal> {

    private static final long serialVersionUID = -323774273;
    ...
    @Override
    public AccountsRecord values(Integer value1, String value2, BigDecimal value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public AccountsRecord(Integer id, String name, BigDecimal balance) {
        super(Accounts.ACCOUNTS);
